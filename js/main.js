(() => {
    ...
    let currentScene = 0; //현재 활성화된 씬(scrollSection)
    let enterNewScene = false; //새로운 scene 이 시작되는 순간 true가 됨
    const sceneInfo = [
        ...
        switch (currentScene) {
            case 0:
                ...
                if (scrollRatio <= 0.22) {
                    ...
                    objs.messageA.style.transform = `translateY(${values.messageA_translateY_out, currentYOffset}%)`;
                }
                ...
                if (scrollRatio <= 0.42) {
                    ...
                    objs.messageB.style.transform = `translateY(${values.messageB_translateY_out, currentYOffset}%)`;
                }
                ...
                if (scrollRatio <= 0.62) {
                    ...
                    objs.messageC.style.transform = `translateY(${values.messageC_translateY_out, currentYOffset}%)`;
                }
                ...
                if (scrollRatio <= 0.82) {
                    ...
                    objs.messageD.style.transform = `translateY(${values.messageD_translateY_out, currentYOffset}%)`;
                }
